...
<div class="min-h-screen">
    <div class="max-w-3xl mx-auto px-4">
        ...
        <h1 class="text-2xl font-semibold text-slate-900 mb-6">Add Sub Category</h1>

        <div class="bg-white rounded-2xl shadow-lg p-6">
            <form method="POST" action="{{ route('slide-subcategories.store') }}" class="space-y-4" enctype="multipart/form-data">
                @csrf
